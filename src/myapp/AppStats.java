...
public class AppStats {
    ...
    public float getLowestAppRating() {
        return lowestAppRating;
    }
    public void setLowestAppRating(float lowestAppRating) {
        this.lowestAppRating = lowestAppRating;
    }
